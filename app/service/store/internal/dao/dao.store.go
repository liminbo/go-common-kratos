...
func (d *dao) StoreByIds(ctx context.Context, storeIds []int64) (stores []*model.Store, e error) {
	if err := d.db.Where("id IN (?)", storeIds).Find(&stores).Error; err != nil{
		log.Error("error is %v", err)
	}
	return
}

func (d *dao) StoreDetail(ctx context.Context, storeId int64) (store *model.Store, err error) {
...
func (d *dao) OfflineStoreDetail(ctx context.Context, storeId int64) (offlineStore *model.OfflineStore, err error) {
...
func (d *dao) OnlineStoreDetail(ctx context.Context, storeId int64) (onlineStore *model.OnlineStore, err error) {
	var store *model.Store
...
func (d *dao) DeleteStore(ctx context.Context, storeId int64) (err error) {
	store := &model.Store{}
...
func (d *dao) StoreResourceList(ctx context.Context, storeId, resourceType int64) (resources []*model.StoreResource, err error) {
...
func (d *dao) StoreResourceImageList(ctx context.Context, storeId int64) (list []*model.StoreResourceImage, err error) {
	var(
		resources []*model.StoreResource
	)
...
func (d *dao) StoreResourceVideoList(ctx context.Context, storeId int64) (list []*model.StoreResourceVideo, err error) {
	var(
		resources []*model.StoreResource
	)
...
func (d *dao) StoreCount(ctx context.Context, storeId int64) (count *model.StoreCount, err error) {
...
func (d *dao) StoreBelone(ctx context.Context, storeId int64) (belongs []*model.StoreBelong, err error) {
...
func (d *dao) AddStoreResource(ctx context.Context, resource *model.StoreResource) (id int64, err error) {
...
func (d *dao) AddStoreResourceImage(ctx context.Context, storeId int64, title, data string, dataInfo *model.StoreResourceImageExt) (id int64, err error) {
...
func (d *dao) AddStoreResourceVideo(ctx context.Context, storeId int64, title, data string, dataInfo *model.StoreResourceVideoExt) (id int64, err error) {
	dataInfoStr,_ := dataInfo.Encode()
	imageResource := &model.StoreResource{
		StoreId:      storeId,
...
func (d *dao) AddStoreBelone(ctx context.Context, storeId int64, belongType int8, belongIds string) (err error) {
...
func (d *dao) StoreFuzzySearch(ctx context.Context, req *v1.FuzzySearchStoreReq) (*model.StoreIdsByEsResult, error) {
	panic("implement me")
}
